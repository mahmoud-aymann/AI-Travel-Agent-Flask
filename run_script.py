...
Checks dependencies and starts the Flask app
"""
...
def start_flask():
    ...
    try:
        ...
        print("❌ Failed to start Flask. Make sure it's installed.")

def main():
    print("🌍 AI Travel Agent - Quick Start (Flask Version)")
    print("=" * 50)
    
    # Check required files
    required_files = ["app.py", "requirements.txt", "templates/index.html", "static/style.css", "static/script.js"]
